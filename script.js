...
const apiKey= 'ElZ53b1hGwbuwAs7cFM5PP4KuAnjJoFg5V5I2Uia';
...
/*function getStatesString(whichStates){
  console.log('getStatesString ran');
  return whichStates.replace(/\s+/g, '&parkCode=');
}*/
